...
- **Studio picker prefetch (Ducon_Library)** — On Studio open, warm space, style, product-type, and product picker images (fire-and-forget; re-runs when catalog metadata arrives).
