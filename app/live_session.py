...
# Use `or` (not the getenv default arg) so that an empty LIVE_SYSTEM_INSTRUCTION
# in .env still falls back to the built-in prompt rather than sending "" to Gemini.
_DEFAULT_SYSTEM_INSTRUCTION = os.getenv("LIVE_SYSTEM_INSTRUCTION") or \
